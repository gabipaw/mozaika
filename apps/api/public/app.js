...
const QUOTE_I18N = {
  ...
  "„Just keep swimming.” — Gdzie jest Nemo": {
    ...
    de: "„Einfach schwimmen.” — Finding Nemo",
    es: "„Sigue nadando.” — Finding Nemo",
    pt: "„Continue nadando.” — Finding Nemo",
    zh: "「一直游就对了。」 — Finding Nemo",
    ja: "「ただ泳ぎ続けるのよ。」 — Finding Nemo",
  },
  "„To infinity… and beyond!” — Toy Story": {
    ...
    zh: "「飞向宇宙，浩瀚无垠！」 — Toy Story",
    ja: "「無限の彼方へ、さあ行くぞ！」 — Toy Story",
  },
  "„I love the smell of napalm in the morning.” — Czas apokalipsy": {
    ...
    zh: "「我喜欢清晨汽油弹的味道。」 — Apocalypse Now",
    ja: "「朝のナパームの匂いは格別だ。」 — Apocalypse Now",
  },
  "„Say hello to my little friend!” — Scarface": {
    ...
    zh: "「跟我的小朋友打个招呼吧！」 — Scarface",
    ja: "「俺の小さな友達に挨拶しな！」 — Scarface",
  },
  "„Carpe diem. Chwytaj dzień.” — Stowarzyszenie Umarłych Poetów": {
    en: "„Carpe diem. Seize the day.” — Dead Poets Society",
    de: "„Carpe diem. Nutze den Tag.” — Dead Poets Society",
    es: "„Carpe diem. Aprovecha el día.” — Dead Poets Society",
    pt: "„Carpe diem. Aproveite o dia.” — Dead Poets Society",
    zh: "「Carpe diem。及时行乐。」 — Dead Poets Society",
    ja: "「カルペ・ディエム。今を生きろ。」 — Dead Poets Society",
  },
  "„Life moves pretty fast…” — Wolny dzień Ferrisa Buellera": {
  ...
  "„Elementary, my dear Watson.” — Sherlock Holmes": {
    ...
    zh: "「基本演绎法，亲爱的华生。」 — Sherlock Holmes",
    ja: "「初歩的なことだよ、ワトソン君。」 — Sherlock Holmes",
  },
  "„Houston, we have a problem.” — Apollo 13": {
    ...
    zh: "「休斯顿，我们有麻烦了。」 — Apollo 13",
    ja: "「ヒューストン、問題が発生した。」 — Apollo 13",
  },
  "„They may take our lives, but they'll never take our freedom!” — Braveheart": {
    ...
    zh: "「他们可以夺走我们的生命，却永远夺不走我们的自由！」 — Braveheart",
    ja: "「命は奪えても、自由は決して奪えない！」 — Braveheart",
  },
  "„What we do in life echoes in eternity.” — Gladiator": {
    ...
    zh: "「我们在世间的所作所为，将回响于永恒。」 — Gladiator",
    ja: "「我々が生きて成すことは、永遠に響き渡る。」 — Gladiator",
  },
  "„You either die a hero, or live long enough to see yourself become the villain.” — Mroczny Rycerz": {
    ...
    es: "„O mueres como un héroe, o vives lo suficiente para verte convertido en villano.” — The Dark Knight",
    pt: "„Ou você morre como herói, ou vive o bastante para se tornar o vilão.” — The Dark Knight",
    zh: "「要么作为英雄死去，要么活到看着自己变成恶棍。」 — The Dark Knight",
    ja: "「英雄のまま死ぬか、生き長らえて悪党に成り果てるかだ。」 — The Dark Knight",
  },
  "„Every man dies. Not every man really lives.” — Braveheart": {
    ...
    zh: "「每个人都会死，但并非每个人都真正活过。」 — Braveheart",
    ja: "「人は皆死ぬ。だが、誰もが本当に生きているわけではない。」 — Braveheart",
  },
  "„Welcome to the real world.” — Matrix": {
    ...
    zh: "「欢迎来到真实的世界。」 — The Matrix",
    ja: "「現実の世界へようこそ。」 — The Matrix",
  },
  "„This is your life, and it's ending one minute at a time.” — Fight Club": {
    ...
    zh: "「这就是你的人生，它正一分一秒地走向终点。」 — Fight Club",
    ja: "「これがお前の人生だ。一分ごとに終わりへと近づいている。」 — Fight Club",
  },
  "„The name's Bond. {name} Bond.” — James Bond": {
  ...
  "„The path of the righteous man is beset on all sides…” — Pulp Fiction": {
    ...
    zh: "「义人的道路四面受敌…」 — Pulp Fiction",
    ja: "「正しき者の道は、四方から脅かされている…」 — Pulp Fiction",
  },
  "„Winter is coming.” — Gra o tron": {
    pl: "„Nadchodzi zima.” — Gra o tron",
    en: "„Winter is coming.” — Game of Thrones",
    de: "„Der Winter naht.” — Game of Thrones",
    es: "„Se acerca el invierno.” — Game of Thrones",
    pt: "„O inverno está chegando.” — Game of Thrones",
    zh: "「凛冬将至。」 — Game of Thrones",
    ja: "「冬が来る。」 — Game of Thrones",
  },
  "„How you doin'?” — Przyjaciele": {
  ...
  "„Say my name.” — Breaking Bad": {
    ...
    zh: "「说出我的名字。」 — Breaking Bad",
    ja: "「俺の名を言ってみろ。」 — Breaking Bad",
  },
  "„I am the one who knocks.” — Breaking Bad": {
    ...
    zh: "「我就是那个敲门的人。」 — Breaking Bad",
    ja: "「ドアを叩くのは、この俺だ。」 — Breaking Bad",
  },
  "„Valar morghulis. Wszyscy ludzie muszą umrzeć.” — Gra o tron": {
    en: "„Valar morghulis. All men must die.” — Game of Thrones",
    de: "„Valar morghulis. Alle Menschen müssen sterben.” — Game of Thrones",
    es: "„Valar morghulis. Todos los hombres deben morir.” — Game of Thrones",
    pt: "„Valar morghulis. Todos os homens devem morrer.” — Game of Thrones",
    zh: "「Valar morghulis。凡人皆有一死。」 — Game of Thrones",
    ja: "「ヴァラー・モルグリス。すべての人間はいつか死ぬ。」 — Game of Thrones",
  },
  "„Not all those who wander are lost.” — Władca Pierścieni": {
    pl: "„Nie każdy, kto wędruje, jest zagubiony.” — Władca Pierścieni",
    en: "„Not all those who wander are lost.” — The Lord of the Rings",
    de: "„Nicht alle, die wandern, sind verloren.” — The Lord of the Rings",
    es: "„No todos los que vagan están perdidos.” — The Lord of the Rings",
    pt: "„Nem todos os que vagueiam estão perdidos.” — The Lord of the Rings",
    zh: "「并非所有游荡者都迷失了方向。」 — The Lord of the Rings",
    ja: "「さすらう者すべてが道に迷っているわけではない。」 — The Lord of the Rings",
  },
  "„Big Brother is watching you.” — Rok 1984": {
  ...
  "„Fear is the mind-killer.” — Diuna": {
    ...
    pt: "„O medo é o assassino da mente.” — Dune",
    zh: "「恐惧是思维的杀手。」 — Dune",
    ja: "「恐怖は精神を殺す。」 — Dune",
  },
  "„So it goes.” — Rzeźnia numer pięć": {
    ...
    de: "„So geht das.” — Slaughterhouse-Five",
    es: "„Así son las cosas.” — Slaughterhouse-Five",
    pt: "„E assim vai.” — Slaughterhouse-Five",
    zh: "「就这么回事。」 — Slaughterhouse-Five",
    ja: "「そういうものだ。」 — Slaughterhouse-Five",
  },
  "„It was the best of times, it was the worst of times.” — Opowieść o dwóch miastach": {
    ...
    de: "„Es war die beste aller Zeiten, es war die schlechteste aller Zeiten.” — A Tale of Two Cities",
    es: "„Era el mejor de los tiempos, era el peor de los tiempos.” — A Tale of Two Cities",
    pt: "„Era o melhor dos tempos, era o pior dos tempos.” — A Tale of Two Cities",
    zh: "「那是最好的时代，也是最坏的时代。」 — A Tale of Two Cities",
    ja: "「それは最良の時代であり、最悪の時代でもあった。」 — A Tale of Two Cities",
  },
  "„Whatever our souls are made of, his and mine are the same.” — Wichrowe Wzgórza": {
    ...
    de: "„Woraus unsere Seelen auch bestehen, seine und meine sind gleich.” — Wuthering Heights",
    es: "„De lo que sea que estén hechas nuestras almas, la suya y la mía son iguales.” — Wuthering Heights",
    pt: "„Seja do que for feita a nossa alma, a dele e a minha são iguais.” — Wuthering Heights",
    zh: "「无论我们的灵魂由什么构成，他的和我的都是一样的。」 — Wuthering Heights",
    ja: "「私たちの魂が何でできていようと、彼のものと私のものは同じだ。」 — Wuthering Heights",
  },
  "„Those who do not understand true pain can never understand true peace.” — Pain (Naruto Shippuden)": {
  ...
  "„Nobody's perfect.” — Pół żartem, pół serio": {
    ...
    de: "„Niemand ist perfekt.” — Some Like It Hot",
    es: "„Nadie es perfecto.” — Some Like It Hot",
    pt: "„Ninguém é perfeito.” — Some Like It Hot",
    zh: "「人无完人。」 — Some Like It Hot",
    ja: "「完璧な人間などいない。」 — Some Like It Hot",
  },
  "„Chase perfection and we can catch excellence.” — Vince Lombardi": {
  ...
  "„We'll always have Paris.” — Casablanca": {
    ...
    zh: "「我们永远拥有巴黎。」 — Casablanca",
    ja: "「僕たちにはいつもパリがある。」 — Casablanca",
  },
  "„After all this time? Always.” — Harry Potter": {
  ...
  "„I'm just a girl, standing in front of a boy…” — Notting Hill": {
    ...
    zh: "「我只是一个女孩，站在一个男孩面前…」 — Notting Hill",
    ja: "「私はただの女の子。一人の男の子の前に立っているだけ…」 — Notting Hill",
  },
  "„Love means never having to say you're sorry.” — Love Story": {
    ...
    zh: "「爱意味着永远不必说对不起。」 — Love Story",
    ja: "「愛とは、決してごめんと言わなくてよいということ。」 — Love Story",
  },
  "„With great power comes great responsibility.” — Spider-Man": {
    ...
    pt: "„Com grandes poderes vêm grandes responsabilidades.” — Spider-Man",
    zh: "「能力越大，责任越大。」 — Spider-Man",
    ja: "「大いなる力には、大いなる責任が伴う。」 — Spider-Man",
  },
  "„Where everybody knows your name.” — Zdrówko (Cheers)": {
  ...
  "„Are you not entertained?!” — Gladiator": {
    ...
    zh: "「你们还不满意吗？！」 — Gladiator",
    ja: "「これでも満足できないのか！？」 — Gladiator",
  },
  "„I'm the king of the world!” — Titanic": {
  ...
  "„Fame! I'm gonna live forever.” — Fame": {
    ...
    es: "„¡Fama! Viviré para siempre.” — Fame",
    pt: "„Fama! Vou viver para sempre.” — Fame",
    zh: "「名声！我将永远活着。」 — Fame",
    ja: "「名声！　私は永遠に生きる。」 — Fame",
  },
  "„It's gonna be legen— wait for it —dary!” — Jak poznałem waszą matkę": {
  ...
  "„Keep your friends close, but your enemies closer.” — Ojciec chrzestny II": {
    ...
    de: "„Halte deine Freunde nah, aber deine Feinde noch näher.” — The Godfather Part II",
    es: "„Ten cerca a tus amigos, y más cerca a tus enemigos.” — The Godfather Part II",
    pt: "„Mantenha os amigos por perto e os inimigos ainda mais perto.” — The Godfather Part II",
    zh: "「亲近你的朋友，但要更亲近你的敌人。」 — The Godfather Part II",
    ja: "「友は近くに置け、だが敵はもっと近くに置け。」 — The Godfather Part II",
  },
  "„Curiouser and curiouser!” — Alicja w Krainie Czarów": {
    pl: "„Coraz ciekawiej i ciekawiej!” — Alicja w Krainie Czarów",
    en: "„Curiouser and curiouser!” — Alice in Wonderland",
    de: "„Immer seltsamer und seltsamer!” — Alice in Wonderland",
    es: "„¡Cada vez más curioso!” — Alice in Wonderland",
    pt: "„Cada vez mais curioso!” — Alice in Wonderland",
    zh: "「越来越奇怪了！」 — Alice in Wonderland",
    ja: "「ますます奇妙だわ！」 — Alice in Wonderland",
  },
  "„The truth is out there.” — Z Archiwum X": {
    pl: "„Prawda jest gdzieś tam.” — Z Archiwum X",
    en: "„The truth is out there.” — The X-Files",
    de: "„Die Wahrheit ist irgendwo da draußen.” — The X-Files",
    es: "„La verdad está ahí fuera.” — The X-Files",
    pt: "„A verdade está lá fora.” — The X-Files",
    zh: "「真相就在那里。」 — The X-Files",
    ja: "「真実はそこにある。」 — The X-Files",
  },
  "„Life is like a box of chocolates.” — Forrest Gump": {
    ...
    zh: "「生活就像一盒巧克力。」 — Forrest Gump",
    ja: "「人生はチョコレートの箱のようなもの。」 — Forrest Gump",
  },
  "„Variety's the very spice of life.” — William Cowper": {
  ...
  "„Toto, I've a feeling we're not in Kansas anymore.” — Czarnoksiężnik z Oz": {
    ...
    de: "„Toto, ich habe das Gefühl, wir sind nicht mehr in Kansas.” — The Wizard of Oz",
    es: "„Toto, tengo la sensación de que ya no estamos en Kansas.” — The Wizard of Oz",
    pt: "„Toto, tenho a sensação de que não estamos mais no Kansas.” — The Wizard of Oz",
    zh: "「托托，我感觉我们已经不在堪萨斯了。」 — The Wizard of Oz",
    ja: "「トト、どうやらここはもうカンザスじゃないみたい。」 — The Wizard of Oz",
  },
  "„Infinite diversity in infinite combinations.” — Star Trek": {
    ...
    zh: "「无限组合中的无限多样性。」 — Star Trek",
    ja: "「無限の多様性を、無限の組み合わせで。」 — Star Trek",
  },
  "„Why not both?” — internetowa mądrość": {
  ...
  "„Great Scott!” — Powrót do przyszłości": {
    ...
    de: "„Great Scott!” — Back to the Future",
    es: "„Great Scott!” — Back to the Future",
    pt: "„Great Scott!” — Back to the Future",
    zh: "「Great Scott！」 — Back to the Future",
    ja: "「Great Scott！」 — Back to the Future",
  },
  "„Roads? Where we're going, we don't need roads.” — Powrót do przyszłości": {
    ...
    de: "„Straßen? Wo wir hinfahren, brauchen wir keine Straßen.” — Back to the Future",
    es: "„¿Carreteras? A donde vamos no necesitamos carreteras.” — Back to the Future",
    pt: "„Estradas? Para onde vamos, não precisamos de estradas.” — Back to the Future",
    zh: "「公路？我们要去的地方不需要公路。」 — Back to the Future",
    ja: "「道路？　これから行く先に道路は要らないさ。」 — Back to the Future",
  },
  "„I've seen things you people wouldn't believe…” — Łowca androidów": {
    ...
    zh: "「我见过你们人类无法相信的事物…」 — Blade Runner",
    ja: "「お前たち人間には信じられないものを見てきた…」 — Blade Runner",
  },
  "„Time is a flat circle.” — Detektyw": {
  ...
  "„Frankly, my dear, I don't give a damn.” — Przeminęło z wiatrem": {
    ...
    de: "„Ehrlich gesagt, meine Liebe, ist mir das gleichgültig.” — Gone with the Wind",
    es: "„Francamente, querida, me importa un bledo.” — Gone with the Wind",
    pt: "„Francamente, minha querida, eu não dou a mínima.” — Gone with the Wind",
    zh: "「坦白说，亲爱的，我一点也不在乎。」 — Gone with the Wind",
    ja: "「正直言って、僕はどうだっていいんだ。」 — Gone with the Wind",
  },
  "„You can't handle the truth!” — Ludzie honoru": {
    pl: "„Nie zniesiesz prawdy!” — Ludzie honoru",
    en: "„You can't handle the truth!” — A Few Good Men",
    de: "„Du verkraftest die Wahrheit nicht!” — A Few Good Men",
    es: "„¡No puedes soportar la verdad!” — A Few Good Men",
    pt: "„Você não aguenta a verdade!” — A Few Good Men",
    zh: "「你根本承受不了真相！」 — A Few Good Men",
    ja: "「お前に真実は受け止められない！」 — A Few Good Men",
  },
  "„What is this? A center for ants?” — Zoolander": {
  ...
  "„My precious.” — Władca Pierścieni": {
    ...
    de: "„Mein Schatz.” — The Lord of the Rings",
    es: "„Mi tesoro.” — The Lord of the Rings",
    pt: "„Meu precioso.” — The Lord of the Rings",
    zh: "「我的宝贝。」 — The Lord of the Rings",
    ja: "「いとしいしと。」 — The Lord of the Rings",
  },
  "„I love it when a plan comes together.” — Drużyna A": {
