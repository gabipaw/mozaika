...
const I18N = {
  ...
  de: {
    ...
    searchMusic: "Album suchen (iTunes)…",
    searchGame: "Spiel suchen (RAWG)…",
    results: "Ergebnisse",
    ...
    noTasteRecs: "Bewerte ein paar Titel, dann entdecken wir Neues für deinen Geschmack.",
    noTasteRecsType:
    ...
    showReplies: "Antworten anzeigen ({n})",
    hideReplies: "Antworten verbergen",
    counts: "{fo} Follower · {fw} gefolgt",
  ...
  es: {
    ...
    searchMusic: "Buscar álbum (iTunes)…",
    searchGame: "Buscar juego (RAWG)…",
    results: "Resultados",
    ...
    noTasteRecs: "Puntúa algunos títulos y descubriremos algo nuevo a tu gusto.",
    ...
    showReplies: "Ver respuestas ({n})",
    hideReplies: "Ocultar respuestas",
    counts: "{fo} seguidores · {fw} seguidos",
  ...
  pt: {
    ...
    searchMusic: "Procurar álbum (iTunes)…",
    searchGame: "Procurar jogo (RAWG)…",
    results: "Resultados",
    resultsFrom: "Resultados de {src}: «{q}»",
    ...
    noTasteRecs: "Avalia alguns títulos e vamos descobrir algo novo ao teu gosto.",
    ...
    showReplies: "Ver respostas ({n})",
    hideReplies: "Ocultar respostas",
    counts: "{fo} seguidores · {fw} a seguir",
    followersLink: "{n} seguidores",
  ...
  zh: {
    ...
    searchMusic: "搜索专辑（iTunes）…",
    searchGame: "搜索游戏（RAWG）…",
    results: "结果",
    ...
    premiereTomorrow: "明天",
    noTasteRecs: "先给几部作品打分，我们就能发现合你口味的新内容。",
  ...
  ja: {
    ...
    searchMusic: "アルバムを検索（iTunes）…",
    searchGame: "ゲームを検索（RAWG）…",
    results: "検索結果",
    ...
    premiereTomorrow: "明日",
    noTasteRecs: "いくつか評価すると、あなた好みの新しい作品を見つけます。",
