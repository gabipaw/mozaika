-- Centrum powiadomień: follow / polubienie recenzji / ocena tytułu z Twojej listy.
-- Zmiana ADDYTYWNA: nowa tabela.
...
ALTER TABLE "Notification" ADD CONSTRAINT "Notification_mediaId_fkey"
